<?php
add_action( 'cmb2_admin_init', 'ebooks_e_materiais_page_register_metabox' );

function ebooks_e_materiais_page_register_metabox() {

    /**
     * TOP BANNER
     */
    $prefix = 'ebooks_e_materiais_banner_';

    $cmb_banner = new_cmb2_box( array(
        'id'            => $prefix . 'banner',
        'title'         => __( 'Banner', 'laf' ),
        'object_types'  => array( 'page' ), // Post type
        'show_on_cb' => 'laf_show_if_ebooks_e_materiais', // function should return a bool value
    ) );
     ...
     * SESSION 1
     */
    $prefix = 'ebooks_e_materiais_section_1_';
...
function laf_show_if_ebooks_e_materiais() {
    ...
    if(isset($_GET['post']) || isset($_GET['post_ID'])) :
        ...
        $templates = array( 'ebooks-e-materiais-page.php' );
