...
add_action( 'prx_modal', 'youtube_gestao_de_oficinas_add_modal' );

function youtube_gestao_de_oficinas_add_modal( $modal_id ) {
	$utils = new Utils;
	$post_id = get_the_ID();
	$modal_arr = [];

	$gestao_de_oficinas_section_2_youtube = get_post_meta( $post_id, 'gestao_de_oficinas_section_2_youtube', true );

	if( $gestao_de_oficinas_section_2_youtube ) :

	?>
		<div id="youtube-modal-gestao-de-oficinas" class="prx-modal modal fade" role="dialog">
			<div class="modal-dialog modal-lg">
					...
					<div class="modal-body">
						<div class="rd-form">
							<div class="embed-responsive embed-responsive-16by9">
								...
								<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $gestao_de_oficinas_section_2_youtube; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
