jQuery( function( $ ) {
    $( document ).ready( function() {
        ...
        $('.box-clientes a').popover({content: '<div class="title">Suporte</div><div class="fone">5018-2525</div><div class="subtitle">ou acesse:</div><div class="popover-url"><a href="#">Portal do Cliente</a></div>', html: true, placement: "bottom"});
    });
});